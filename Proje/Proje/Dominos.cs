...
namespace Proje
{
    public partial class Dominos : UserControl
    {
        double price_food1 = 40;
        double price_food2 = 23;
        double price_food3 = 18;
        double price_food4 = 32;
        double price_food5 = 28;
        double price_drink1 = 4.99;
        double price_drink2 = 6;
        double price_drink3 = 7.99;
        double price_drink4 = 5.5;
        double price_drink5 = 4.99;
        double price_extra1 = 9;
        double price_extra2 = 15;
        double price_extra3 = 4.5;
        double price_extra4 = 5;
        double price_extra5 = 7.99;
