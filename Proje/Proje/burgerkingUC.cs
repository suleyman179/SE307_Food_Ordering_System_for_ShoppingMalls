...
namespace Proje
{
    public partial class burgerkingUC : UserControl
    {
        double price_food1 = 30;
        double price_food2 = 17;
        double price_food3 = 23;
        double price_food4 = 25;
        double price_food5 = 28;
        double price_drink1 = 5;
        double price_drink2 = 4;
        double price_drink3 = 6;
        double price_drink4 = 5;
        double price_drink5 = 5;
        double price_extra1 = 7;
        double price_extra2 = 11;
        double price_extra3 = 1;
        double price_extra4 = 1;
        double price_extra5 = 1;
        ...
        private void food1box_CheckedChanged(object sender, EventArgs e)
        {
        ...
        {
            if (foodBox2.Checked == true)
            {
                txtFood2.Enabled = true;
                txtFood2.Text = "";
                txtFood2.Focus();
            }
            else
            {
                txtFood2.Enabled = false;
                txtFood2.Text = "0";
            }
        }
        ...
        {
            if (foodBox3.Checked == true)
            {
                txtFood3.Enabled = true;
                txtFood3.Text = "";
                txtFood3.Focus();
            }
            else
            {
                txtFood3.Enabled = false;
                txtFood3.Text = "0";
            }
        }
        ...
        {
            if (foodBox4.Checked == true)
            {
                txtFood4.Enabled = true;
                txtFood4.Text = "";
                txtFood4.Focus();
            }
            else
            {
                txtFood4.Enabled = false;
                txtFood4.Text = "0";
            }
        }
        ...
        {
            if (foodBox5.Checked == true)
            {
                txtFood5.Enabled = true;
                txtFood5.Text = "";
                txtFood5.Focus();
            }
            else
            {
                txtFood5.Enabled = false;
                txtFood5.Text = "0";
            }
        }
