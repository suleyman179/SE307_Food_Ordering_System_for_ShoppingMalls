...
namespace Proje
{
    public partial class McDonalds : UserControl
    {
        double price_food1 = 29.99;
        double price_food2 = 19.99;
        double price_food3 = 23.5;
        double price_food4 = 21;
        double price_food5 = 23.49;
        double price_drink1 = 5.5;
        double price_drink2 = 4;
        double price_drink3 = 5.99;
        double price_drink4 = 7;
        double price_drink5 = 3.99;
        double price_extra1 = 5;
        double price_extra2 = 9.99;
        double price_extra3 = 1.5;
        double price_extra4 = 2;
        double price_extra5 = 1.99;
