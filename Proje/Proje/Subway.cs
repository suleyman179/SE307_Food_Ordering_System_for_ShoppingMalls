...
namespace Proje
{
    public partial class Subway : UserControl
    {
        double price_food1 = 22;
        double price_food2 = 25;
        double price_food3 = 19;
        double price_food4 = 33;
        double price_food5 = 15;
        double price_drink1 = 3.5;
        double price_drink2 = 4.5;
        double price_drink3 = 2.5;
        double price_drink4 = 5;
        double price_drink5 = 6;
        double price_extra1 = 4;
        double price_extra2 = 6.5;
        double price_extra3 = 3;
        double price_extra4 = 4;
        double price_extra5 = 5;
